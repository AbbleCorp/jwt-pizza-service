...
orderRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      logger.log('info', 'factory_request', { requestBody: factoryRequestBody });
      ...
      logger.log('info', 'factory_response', { responseBody: j, statusCode: r.status });


      const latency = performance.now() - start;
      metrics.recordCreationLatency(latency);
